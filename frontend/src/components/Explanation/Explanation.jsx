      ...
      <div className="flex items-center justify-between border-b border-outline-variant pb-sm mb-md">
        ...
        <div className="flex gap-2 items-center">
          <div className="relative group cursor-help">
            ...
            <div className="absolute right-0 top-full mt-2 hidden group-hover:block w-48 bg-surface-container-highest text-on-surface text-xs p-2 rounded shadow-lg z-20 font-normal normal-case tracking-normal">
              How we estimate confidence: based on completeness of answers and how clearly they match guideline patterns.
            </div>
          </div>
          <span className="font-label-sm text-label-sm text-on-surface-variant bg-surface-container-high px-2 py-1 rounded border border-outline-variant uppercase tracking-widest text-[10px]">
